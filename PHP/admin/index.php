...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="jumbotron">
            <h1>Welcome to the Claridge Court Library</h1>
            <p>Find videos, text, and search for books.</p>
        </div>

        <div class="row">
            <div class="col-md-6">
                <a href="add/" class="thumbnail btn-thumb-home">
                    Add a Book
                </a>
            </div>
            <div class="col-md-6">
                <a href="sql/" class="thumbnail btn-thumb-home">
                    Sql
                </a>
            </div>
        </div>
